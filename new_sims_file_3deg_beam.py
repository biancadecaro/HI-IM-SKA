...
plt.xlabel('ell')
plt.legend()
plt.savefig('gauss_beam_3_1p41_deg.png')
plt.show()
...
import pickle
filename = f'Sims/beam_theta{theta_FWMH*180./np.pi:1.2f}deg_no_mean_sims_synch_ff_ps_{len(nu_ch_new)}freq_{min(nu_ch_new)}_{max(nu_ch_new)}MHz_lmax{lmax}_nside{nside}'
