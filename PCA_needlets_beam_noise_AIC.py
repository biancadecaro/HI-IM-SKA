...
out_dir_output_PCA = out_dir_output+f'PCA_maps/No_mean/Beam_{beam_s}_noise/'
out_dir_plot = out_dir_output+f'Plots_PCA_needlets/No_mean/Beam_{beam_s}_noise/'#noise_mask_patch_stripe82_noise_mask0.39
...
need_dir = f'Maps_needlets/No_mean/Beam_{beam_s}_noise/'
...
for j in range(Cov_channels.shape[0]):
    ...
    #        Cov_channels[j,c,cc]=np.dot(need_tot_maps[c,j,:],need_tot_maps[cc,j,:].T)
