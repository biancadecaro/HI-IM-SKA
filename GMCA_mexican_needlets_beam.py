...
import sys
sys.path.insert(1, '/home/bianca-ubuntu/Documents/gmca4im-master/scripts/')
...
out_dir_output = 'GMCA_mexican_needlets_output/'
out_dir_output_GMCA = out_dir_output+'GMCA_maps/No_mean/p1/Beam_40arcmin/'
out_dir_plot = out_dir_output+'Plots_GMCA_needlets/No_mean/p1/Beam_40arcmin/'
