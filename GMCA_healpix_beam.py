...
################################################################
out_dir= 'GMCA_pixels_output/Maps_GMCA/No_mean/Beam_40arcmin/'
out_dir_plot = 'GMCA_pixels_output/Plots_GMCA/No_mean/Beam_40arcmin/'
...
np.save(out_dir+f'res_GMCA_HI_{fg_components}_{num_freq}_{min(nu_ch)}_{max(nu_ch)}MHz_Nfg{num_sources}_lmax{lmax}_nside{nside}.npy',res_HI)
...
np.savetxt(out_dir_cl+f'cl_input_fg_{fg_components}_lmax{lmax_cl}_nside{nside}.dat', cl_fg)
np.savetxt(out_dir_cl+f'cl_GMCA_HI_{fg_components}_Nfg{num_sources}_lmax{lmax_cl}_nside{nside}.dat', cl_Hi_recons_Nfg)
