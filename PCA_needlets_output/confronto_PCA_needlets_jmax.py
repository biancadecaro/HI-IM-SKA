...
plt.savefig(f'Plots_paper_nuovo/comparison_cl_std_jmax_need_ch{nu_ch[ich]}_{fg_comp}_noise_beam_{beam_s}_jmax{jmax_4}_jmax{jmax_12}_Nfg{Nfg}_nside{nside}_mask0.5.png', bbox_inches='tight')
...
frame2.set_xticks(np.arange(lmin,lmax_plot+1, 20))
#plt.legend(loc='upper right')
plt.savefig(f'Plots_paper_nuovo/comparison_cl_std_jmax_need_mean_ch_{fg_comp}_noise_beam_{beam_s}_jmax{jmax_4}_jmax{jmax_12}_Nfg{Nfg}_nside{nside}_mask0.5.png', bbox_inches='tight')
