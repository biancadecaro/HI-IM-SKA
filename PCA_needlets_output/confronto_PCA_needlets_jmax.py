...
fig=plt.figure()
fig.suptitle(f'mean over channels, jmax:12, lmax:{lmax}, Nfg:{Nfg}')
...
fig=plt.figure()
fig.suptitle(f'mean over channels, jmax:4, lmax:{lmax_cl}, Nfg:{Nfg}')
plt.plot(ell[2:], 100*np.abs(np.mean(diff_PCA_beam_jmax4, axis=0))[2:],'--',mfc='none', label='PCA Beam Need')
plt.plot(ell[2:], 100*np.abs(np.mean(diff_PCA_jmax4, axis=0))[2:],'--',mfc='none', label='PCA No Beam Need')
...
plt.plot(ell[2:], 100*np.abs(np.mean(diff_PCA_beam_jmax12, axis=0))[2:],'--',mfc='none', label='PCA Beam Need')
plt.plot(ell[2:], 100*np.abs(np.mean(diff_PCA_jmax12, axis=0))[2:],'--',mfc='none', label='PCA No Beam Need')
...
plt.plot(ell[2:], 100*np.abs(np.mean(diff_PCA_beam_jmax4, axis=0))[2:],'--',mfc='none', label='PCA Beam Need jmax=4')
plt.plot(ell[2:], 100*np.abs(np.mean(diff_PCA_jmax4, axis=0))[2:],'--',mfc='none', label='PCA No Beam Need jmax=4')

plt.plot(ell[2:], 100*np.abs(np.mean(diff_PCA_beam_jmax12, axis=0))[2:],'--',mfc='none', label='PCA Beam Need jmax=12')
plt.plot(ell[2:], 100*np.abs(np.mean(diff_PCA_jmax12, axis=0))[2:],'--',mfc='none', label='PCA No Beam Need jmax=12')


plt.plot(ell[2:], 100*np.abs(np.mean(diff_PCA_beam_sph, axis=0))[2:],'k--',mfc='none', label='PCA Beam deg Sph')
#plt.plot(ell[2:], 100*np.abs(np.mean(diff_PCA_sph, axis=0))[2:],'--',mfc='none', label='PCA No Beam Sph')
...
plt.legend()
plt.tight_layout()
plt.savefig('beam_convu_no_beam_cls_need_sph.png')
plt.show()

fig=plt.figure()
fig.suptitle(f'BEAM, mean over channels, lmax:{lmax_cl}, Nfg:{Nfg}')
...
plt.legend()
plt.tight_layout()
plt.savefig('beam_convu_cls_need_sph.png')
plt.show()