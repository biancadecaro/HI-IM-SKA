...
dir_GMCA = 'GMCA_maps/No_mean/Beam_theta40arcmin_noise_mask0.20/'
...
path_cosmo_HI = f'../GMCA_pixels_output/Maps_GMCA/No_mean/Beam_theta40arcmin_noise_mask0.20/cosmo_HI_noise_{num_ch}_{min_ch:1.1f}_{max_ch:1.1f}MHz_lmax{lmax}_nside{nside}'
path_fg = f'../GMCA_pixels_output/Maps_GMCA/No_mean/Beam_theta40arcmin_noise_mask0.20/fg_input_{fg_comp}_{num_ch}_{min_ch:1.1f}_{max_ch:1.1f}MHz_lmax{lmax}_nside{nside}'
