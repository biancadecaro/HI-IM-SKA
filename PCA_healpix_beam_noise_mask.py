...
mask1_40 = hp.read_map('HFI_Mask_GalPlane_2048_R1.10.fits', field=1)#fsky 20 % coverage
...
fig=plt.figure()
hp.mollview(mask_40s, cmap='viridis', title=f'Mask smoothed, fsky={np.mean(mask_40s):0.2f}', hold=True)
plt.show()
