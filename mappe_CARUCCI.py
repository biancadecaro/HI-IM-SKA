...
fig.add_subplot(221) 
hp.mollview(file['gal_synch'][ich], cmap='viridis', norm='log',title=f'Gal sync, freq={nu_ch[ich]}', hold=True)
fig.add_subplot(222) 
hp.mollview(file['gal_ff'][ich], cmap='viridis', norm='log',title=f'Gal ff, freq={nu_ch[ich]}',hold=True)
fig.add_subplot(223)
hp.mollview(file['point_sources'][ich], norm='log',title=f'Point sources, freq={nu_ch[ich]}',cmap='viridis', hold=True)
fig.add_subplot(224)
hp.mollview(file['cosmological_signal'][ich], norm='log', title=f'Cosmological signal, freq={nu_ch[ich]}',cmap='viridis', hold=True)
plt.show()
