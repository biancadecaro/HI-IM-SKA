...
plt.savefig(f'Plots_paper/cl_components_beam_mask_SKA_AA4_HI_sync_ff_ps_pol_ch{nu_ch[ich]}MHz_lmax{lmax_cl}_nside{nside}.png')
...
plt.xlabel(r'$\ell$')
plt.legend(ncols=1, loc='upper right')
plt.savefig(f'Plots_paper/cl_components_beam_mask_SKA_AA4_fill_between_HI_sync_ff_ps_pol_ch_min_max{lmax_cl}_nside{nside}.png')
