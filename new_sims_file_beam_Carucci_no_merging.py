...
import pickle
filename = f'Sims/beam_Carucci_no_mean_sims_synch_ff_ps_{len(nu_ch_new)}freq_thick{delta_nu_out}_{min(nu_ch_new)}_{max(nu_ch_new)}MHz_lmax{lmax}_nside{nside}'
